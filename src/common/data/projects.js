const projects = [
  {
    ...
    files: [
      { name: "Logic Cars Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Logic Cars Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Logic Cars Logo.Zip", size: "2.02 MB", link: "#" },
