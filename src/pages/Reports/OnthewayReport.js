...
function Accepeted() {
  ...
  const getBookingReports = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/onthewaybookingreport",
        dataArray,
        {
  ...
  const csvReport = {
    filename: "ON The Way / Arrival Booking Report",
    data: userInCsv,
  }
        ...
        <div className="page-content">
          <Container fluid>
            <Breadcrumbs
              ...
              breadcrumbItem="ON The Way / Arrival Booking Report"
            />
