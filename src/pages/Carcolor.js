...
const Brand = () => {
  ...
  const addbrands = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/color/addcarcolor",
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const editbrands = () => {
    ...
    dataArray.append("isActive", form1.isActive)
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/color/editcarcolors" +
          "/" +
          docid,
        dataArray,
        {
  ...
  const deletefeature = data => {
    ...
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/color/disablecarcolors" +
          "/" +
          remid,
        {},
        {
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        `http://103.186.185.77:5021/api/v1/admin/color/getallcarcolors?searchQueryParams=${e.target.value}`,
        {},
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Car Color" />
          ...
          <Row>
              ...
              <Col md={4}>
                <Card>
                  <CardHeader className="bg-white">
                    <CardTitle>Add Car Color</CardTitle>
                  </CardHeader>
                  <CardBody>
                    <Form
                      onSubmit={e => {
            ...
            {dats.carMgtAdd == true|| dats1 == "admin" ? (
              <Col md={8}>
                <Card>
                  <CardHeader className="bg-white">
                    <CardTitle>Car Color List</CardTitle>
                  </CardHeader>
