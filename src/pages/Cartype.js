...
const Brand = () => {
  ...
  const getAllbrand = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/cartype/getallcartypes",
        {},
        {
  ...
  const addbrands = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/cartype/addcartype",
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const editbrands = () => {
    ...
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/cartype/editcartypes" +
          "/" +
          docid,
        dataArray,
        {
  ...
  const deletefeature = data => {
    ...
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/cartype/disablecartypes" +
          "/" +
          remid,
        {},
        {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Car Type" />
          ...
          <Row>
              ...
              <Col md={4}>
                <Card>
                  <CardHeader className="bg-white">
                    <CardTitle>Add Car Type</CardTitle>
                  </CardHeader>
                  <CardBody>
                    <Form
                      onSubmit={e => {
            ...
            {dats.carMgtAdd == true || dats1 == "admin" ? (
              <Col md={8}>
                <Card>
                  <CardHeader className="bg-white">
                    <CardTitle>Car Type List</CardTitle>
                  </CardHeader>
