...
const Viewbooking = () => {
  ...
  const getonebooking = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getimmediatebooking",
        dataArray,
        {
  ...
  const [form, setform] = useState({ damageCharges: "", salikTollCharges: "", parkingCharges: "", trafficPrice: "" })
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="iMMEDIATE Booking Details" />
                        ...
                        <Table className="table table-bordered mb-4 mt-3">
                          <thead>
                            <tr>
                              ...
                              <th>Total Days</th>
                              <th>VAT</th>
                              <th>Transtation Charges</th>
                              <th>Total price</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td> {user.bookingSlot} </td>
                              <td> {user.rideUnitPrice} AED</td>
                              <td>{user.securityDeposit} AED</td>
                              <td>{user.insuranceTypeSelect} </td>
                              <td>{user.insurancePrice} AED</td>
                              <td>{user.noOfBookingDays} Days</td>
                              <td>{user.gst} AED</td>
                              <td>{user.transactionCharges} AED</td>
