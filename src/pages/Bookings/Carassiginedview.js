...
const Viewbooking = () => {
  ...
  const getonebooking = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getacceptedbooking",
        dataArray,
        {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="car Assigned Booking Details" />
              ...
              <Card>
                ...
                <Row>
                  <Col md="4">
                    <div className="avatar-md profile-user-wid">
                      <img
                        src={"http://103.186.185.77:5021/" + user.asiignDriverDlfrontUAE}
                        alt=""
                        style={{ height: "70px" }}
                        className="img-thumbnail rounded-circle"
                      />
                  ...
                  <Col sm={8}>
                    <div className="pt-2">
                      <Row>
                        <Col xs="12">
                          <h5 className="font-size-15">{user.assignDriverName}</h5>
                        </Col>
                      </Row>
                    </div>
                  </Col>
                    ...
                    <ul className="list-unstyled ">
                      <li>
                        <div className="d-flex">
                          <i className="bx bx-right-arrow-circle fs-4"></i>
                          <div className="ms-3">
                            <h6 className="fs-14 mb-2">Driver Name</h6>
                            <p className="text-muted fs-14 mb-0">
                              {user.assignDriverName}
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="mt-3">
                        <div className="d-flex">
                          <i className="bx bx-right-arrow-circle fs-4"></i>
                          <div className="ms-3">
                            <h6 className="fs-14 mb-2">Driver Phone</h6>
                            <p className="text-muted fs-14 mb-0">
                              {user.assignDriverPhone}
                            </p>
                          </div>
                        </div>
                      </li>
                      <li className="mt-3">
                        <div className="d-flex">
                          <i className="bx bx-right-arrow-circle fs-4"></i>
                          <div className="ms-3">
                            <h6 className="fs-14 mb-2">Driver Email</h6>
                            <p className="text-muted fs-14 mb-0">
                              {user.assignDriverEmail}
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="mt-3">
                        <div className="d-flex">
                          <i className="bx bx-right-arrow-circle fs-4"></i>
                          <div className="ms-3">
                            <h6 className="fs-14 mb-2">Driver Location</h6>
                            <p className="text-muted fs-14 mb-0">
                              {user.assignDriverAddress}
                            </p>
                          </div>
                        </div>
                      </li>
                          ...
                          <div className="ms-3">
                            ...
                            <p className="text-muted fs-14 mb-0">
                              <a
                                ...
                                className="bg-danger text-white p-1"
                              >
                                {user.assignDate} /  {user.assignTime}</a>
                            </p>
                          </div>
                        </div>
                      </li>
                  ...
                  <div className="d-flex">
                    <div className="flex-grow-1">
                      <div>
                        ...
                        <Table className="table table-bordered mb-5 mt-5">
                          <thead>
                            <tr>
                              <th>Price </th>
