...
const Booking = () => {
  ...
  const [activeTab1, setactiveTab1] = useState("8")
  const toggle1 = tab => {
    if (activeTab1 !== tab) {
      setactiveTab1(tab)
    }
  ...
  const searchchange = e => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getallcanceledbookings",
        dataArray,
        {
      ...
      .then(res => {
        setbooking(res.data.canceledBookingResult)
      })
  }
  ...
  return (
    ...
    <div className="page-content">
      <Container fluid>
        {/* Render Breadcrumbs */}
        <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Cancelled Bookings" />
