...
const Viewbooking = () => {
  ...
  const getonebooking = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getcompletedbooking",
        dataArray,
        {
      ...
      .then(res => {
        ...
        // setview(res.data.customerReview)
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Closed Booking Details" />
                ...
                <CardBody>
                  <div className="mt-2">
                    ...
                    <div className="d-flex py-3 border-bottom">
                      {/* <img
                        src={"http://103.186.185.77:5021/" + review.customerImage}
                        className="avatar-xs me-3 rounded-circle"
                        alt="img"
                      /> */}
                      <div className="flex-grow-1">
                        <h5 className="mt-0 mb-1 font-size-15">Brian</h5>
                        <p className="text-muted">{review.remark}</p>
                        <Rating
                        ...
                        {rating}
                        <div className="text-muted font-size-12 mt-4">
                          <i className="far fa-calendar-alt text-primary me-1"></i>
                          {review.logDateCreated}
                        </div>
                      </div>
                    </div>
                  </div>
