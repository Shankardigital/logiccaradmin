...
const Booking = () => {
  ...
  const searchchange = e => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getallcollectnowbookings",
        dataArray,
        {
      ...
      .then(res => {
        setbooking(res.data.collectNowBookingResult)
      })
  }
  ...
  return (
    ...
    <div className="page-content">
      <Container fluid>
        {/* Render Breadcrumbs */}
        <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Collect NOW Bookings" />
    ...
    //                           <td>{data.driverName}<br></br>{data.driveremail}<br></br>{data.driverphone}</td>
    //                           <td> <a
    //                             style={{ borderRadius: "5px" }}
    //                             className="bg-danger text-white p-1"
    //                           >
    //                             {data.assignStatus} {data.cancelReason}
    //                           </a></td>
