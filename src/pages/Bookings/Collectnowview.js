...
const Viewbooking = () => {
  ...
  const getonebooking = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getcollectnowbooking",
        dataArray,
        {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Collect now BOOKINGS Details" />
              ...
              <Card>
                ...
                <Row>
                  <Col md="4">
                    <div className="avatar-md profile-user-wid">
                      <img
                        src={"http://103.186.185.77:5021/" + user.collectDriverPic}
                        alt=""
                        style={{ height: "70px" }}
                        className="img-thumbnail rounded-circle"
                      />
