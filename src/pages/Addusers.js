...
const Addusers = () => {
  ...
  const getAllcustomer = () => {
    ...
    axios
      .post(
        " http://103.186.185.77:5021/api/v1/admin/customer/getadminsidecustomers",
        dataArray,
        {
  ...
  const disablecust = () => {
    ...
    const dataArray = new FormData()
    dataArray.append("reason", forms.reason)
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        `http://103.186.185.77:5021/api/v1/admin/customer/getadminsidecustomers?searchQueryParams=${e.target.value}`,
        dataArray,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Direct User List" />
