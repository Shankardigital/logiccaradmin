...
const Rentinvoice = () => {
  ...
  const getAllPayments = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/voucher/getallrentalinvoices",
        dataArray,
        {
  ...
  const getdata1 = data => {
    sessionStorage.setItem("invoice", data._id)
    handleClick1234()
  }
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Rental Invoices" />
