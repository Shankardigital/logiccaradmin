...
function PrivacyPolicy() {
  ...
  const getAllPayments = () => {
    ...
    axios
      ...
      .then(res => {
        setform(res.data.policyResult.privacyPolicy)
      })
  }
  ...
  const changstatus = () => {
    ...
    const dataArray = new FormData()
    dataArray.append("privacyPolicy", text1)

    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/driverPolicy/updateprivacypolicy",
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Driver Privacy Policy" />
          <Row>
            <Col md={12}>
              <Card>
