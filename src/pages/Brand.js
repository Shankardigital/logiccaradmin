...
const Brand = () => {
  ...
  const addbrands = () => {
    ...
    axios
      .post(URL.addcarbrands, dataArray, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const editbrands = () => {
    ...
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/brand/editcarbrand" +
          "/" +
          docid,
        dataArray,
        {
  ...
  const deletefeature = data => {
    ...
    axios
      .put(
        "http://103.186.185.77:5021/api/v1/admin/brand/disablecarbrand" +
          "/" +
          remid,
        {},
        {
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        `http://103.186.185.77:5021/api/v1/admin/brand/getallcarbrands?searchQuery=${e.target.value}`,
        {},
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Car Brands" />
