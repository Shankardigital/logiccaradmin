...
const Booking = () => {
  ...
  const searchchange = e => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/getallimmidiatebookings",
        dataArray,
        {
      ...
      .then(res => {
        setbooking(res.data.immBookingResult)
      })
  }
  ...
  return (
    <React.Fragment>
   {dats.bookingview == true || dats1 == "admin" ? (
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Logic Cars Admin" breadcrumbItem="Immediate Bookings" />
