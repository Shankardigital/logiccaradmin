...
const AddBooking = args => {
  ...
  const handlefiliter = e => {
    ...
    const dataArray = new FormData()
    dataArray.append("branchId", localStorage.getItem("ids"))
    dataArray.append("carTypeId", filiter.e.target.value)
  ...
  const handlefiliter1 = e => {
    ...
    dataArray.append("carBrandId", e.target.value)
    dataArray.append("carModelId", filiter.carModelId)
  ...
  const handlefiliter2 = e => {
    ...
    dataArray.append("carTypeId", filiter.carTypeId)
    dataArray.append("carBrandId", filiter.carBrandId)
    dataArray.append("carModelId", e.target.value)
  ...
  console.log(tagging.lat)


  const [tagging1, settagging1] = useState([])


  console.log(tagging1)
  ...
  const handleSelects1 = async value => {
    ...
    geocodeByAddress(value)
      .then(results => getLatLng(results[0]))
      .then(latLng => settagging1(latLng))
  ...
  // const defaultProps = {
  //   center: {
  //     lat: coordinateds.lat,
  //     lng: coordinateds.lng,
  //   },
  //   zoom: 11,
  // }
  ...
  //   googleMapsApiKey:
  //     "AIzaSyDrQG115rY50cbBDbjq2XaQGdAnlncD5e0",
  //   libraries,
  // })
  ...
  const handleChangedate = e => {
    ...
    const countdays1 = totaldays / (1000 * 60 * 60 * 24 * 7)

    const countdays2 = totaldays / (1000 * 60 * 60 * 24 * 7)
    ...
    if (countdays < 7) {
      const user1 = 1 * form.priceId
      setpot(user1)

    }
    if (countdays > 6 && daySlot < 25) {
      const user1 = 2 * form.priceId
      setpot(user1)
    }
  ...
  const addnewcar = () => {
    ...
    axios
      .post(
        "http://103.186.185.77:5021/api/v1/admin/carbooking/addbooking",
        dataArray,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const validateFun1 = e => {
    if (activeTab == 1) {
      ...
      else if (res.returnDate == null || res.returnDate == "" ) {
        let error = { ...er }
  ...
  function handleCheckboxClick(carId) {
    setSelectedCheckbox(carId);
  }
                                    ...
                                    <Row>
                                      ...
                                      >
                                        ...
                                        <div className="text-center">
                                          ...
                                          >
                                            <input type="radio" id="radiomiddle" name="align" value="middle" />Select
                                          </label>

                                          <input type="radio" id="radioleft" name="align"  onClick={() => {
                                              handleclics(data),
                                                toggleTab(activeTab + 1)
                                            }}  /> */}
                                          {/* <div>
        ...
        <label key={option.value}>
          ...
          {option.label}
                                          ...
                                          >
                                            ...
                                            <input type="radio" id="radiomiddle" name="align" />Select
                                          </label> */}
                                          ...
                                          <input type="radio" className="btn-check" id={`btn-check-2-outlined${key}`} name="align" value={data._id} onClick={() => {
                                            handleclics(data)
                                          }} />
                                          <label className="btn btn-outline-primary" htmlFor={`btn-check-2-outlined${key}`}>Select</label>
                                      ...
                                      {pack.map((data, key) => {
                                        return (
                                          <option key={key} value={data._id}>
                                            {data.packName} / {data.price} AED / {data.mileage} kMS
                                          </option>
                                        )
                                      })}
                                    </select>
        ...
        >
          ...
          {response !== null && (
            ...
            />
                                  ...
                                  <div>
                                    ...
                                    <Row className="mt-5">
                                      ...
                                      <Col>
                                        ...
                                        >
                                          + {singlecar.securityDeposite} AED
                                        </span>
                                        <br />
                      ...
                      {activeTab === 2 ? <>
                        {errorObject.carId != "" ? <div
                        ><p style={{
                          color: 'red',
                          fontSize: "16px"
                        }}>{errorObject.carId}</p></div> : ""} </> : ""}
...
// "AIzaSyCuprhlOtAFpOfhaYMs5fYdjdnnla57BLg"